...
function makeValidation() {
  document.querySelector(
    ".valid_container"
  ).innerHTML += `<h2>Confirmation de commande</h2>
    <p>Merci ${localStorage.getItem("user_name")} ${localStorage.getItem(
    "user_prenom"
  )} votre commande n°${Math.floor(
    Math.random() * 70000000000
  )} à bien été pris en compte par notre équipe !</p>
    <p>Vous serez livré dans les 48h a : ${
      localStorage.getItem("user_adress") +
      " " +
...
setTimeout(redirectionIndex, 31000);
